...
- [ ] Widget can be added to empty workspace
- [ ] Each widget is draggable and resizable
...
- [x] Integrate HeatmapSettingsModal with HeatmapWidget ⬅️ IN PROGRESS
- [ ] Improve heatmap visualization

### Toolbar Improvements:
- [x] Add Layout dropdown (Untitled Layout) ⬅️ IN PROGRESS
- [ ] Add COIN button
- [x] Add fullscreen toggle ⬅️ IN PROGRESS
- [x] Better FPS counter in status bar ⬅️ IN PROGRESS
- [x] Region selector (EU West, etc.) ⬅️ IN PROGRESS
- [x] Latency display (ms) ⬅️ IN PROGRESS
- [x] UTC time display ⬅️ IN PROGRESS

## In Progress:
- [x] Integrate WidgetMenu into Toolbar
- [ ] Create draggable/resizable widget system
- [x] Add Trades Widget
- [x] Add Stats Widget
